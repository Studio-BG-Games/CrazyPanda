...
inline void InitializeParticleLitSurfaceData(float2 uv, float3 blendUv, float4 particleColor, float4 projectedPosition, out SurfaceData outSurfaceData, float4 dissolveCutout)
{
    half4 albedo = SampleAlbedo(uv, blendUv, _BaseColor, particleColor, projectedPosition, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap));
     ...
     //Advanced Dissolve/////////////////////////////////////////
            ...
            AdvancedDissolveCalculateAlphaAndClip(dissolveCutout, albedo.a, _Cutoff);
        #endif
 ...
 //Advanced Dissolve
inline void InitializeParticleLitSurfaceData(ParticleParams params, out SurfaceData outSurfaceData, float4 dissolveCutout)
{
